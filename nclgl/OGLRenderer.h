...
public:
	...
	/*void			SetModelMatrix(const Matrix4& m) { modelMatrix = m; }
	void			BindShaderForSceneNode(Shader* s) { BindShader(s); }
	void			UpdateShaderMatricesForSceneNode() { UpdateShaderMatrices; }*/
